"""Independent graph/path controls for the classification proof in the manuscript.
...
def main():
    ...
    result={'status':'PASS','binary_nonroot_axiom_checks':axiom_checks,
            ...
            'scope':'Finite controls; all-start avoidance is proved in the manuscript and the finite-alphabet negative construction is formalized in the Lean project.'}
